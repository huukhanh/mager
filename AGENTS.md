...
- All resource names follow the pattern `<INSTANCE_NAME>-mager`; they are derived in setup.sh from a single INSTANCE_NAME prompt — do not introduce a new prompt for individual resource names
